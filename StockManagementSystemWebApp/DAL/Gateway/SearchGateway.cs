...
namespace StockManagementSystemWebApp.DAL.Gateway
{
    public class SearchGateway:CommonGateway
    {
        ...
        public List<SearchSoldItemViewModel> GetSoldItemByDate(string fromDate, string toDate)
        {
            ...
            string query = "SELECT Items.ItemName as ItemName, Company.CompanyName, sum(StockOutQuantity) as TotalQuantity FROM Items, StockOut, Company WHERE StockOut.Date>= @fromDate and StockOut.Date<= @toDate and StockOut.Type = 'Sold' and Items.Id = StockOut.ItemId and Company.Id = Items.CompanyId and Company.Id = Stockout.CompanyId Group by StockOut.CompanyId, StockOut.ItemId,Company.CompanyName,Company.Id, Items.ItemName";
            Command = new SqlCommand(query, Connection);
