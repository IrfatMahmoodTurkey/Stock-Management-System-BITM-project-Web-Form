<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategorySetupUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.CategorySetupUI"%>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="add-company-form">
                        ...
                        <asp:GridView ID="categoryGridView" runat="server" CssClass="add-company-form-table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Update">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="updateButton" runat="server" formnovalidate="formnovalidate" Text="Update" CssClass="btn btn-success" OnClick="updateButton_OnClick"/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
